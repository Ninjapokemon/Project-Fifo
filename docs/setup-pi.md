...
- `oled.preview_mode`: preview source mode: `preset` (default) uses active project frame/animation data on the Pi and falls back to Pi-side event presets, `mirror` shows transformed live LED pixels
